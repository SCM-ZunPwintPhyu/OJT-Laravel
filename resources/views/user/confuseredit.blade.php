...
@section('content')
<div class="container">
    <form class="form-style-9" method="post" action="{{ route('user_update', $data->id)}}"
        ...
        <ul>
            ...
            <li>
                ...
                <textarea class="field-style field-full align-none" name="address" rows="5">{{ old('address',$data->address) }}</textarea>
                <span style="color:red"> </span>
            </li>
            <li>
                <a href="{{ route('user_changepass', $data->id)}}" class="" style="float:left">Change Password</a>
            </li>
            <li>
