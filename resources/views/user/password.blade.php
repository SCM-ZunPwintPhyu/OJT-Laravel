...
<form  method="post" action="{{ route('profile_update', $data->id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div style="width:800px">
            ...
            <input type="password" name="password" class="field-style field-full align-none form-control" value="{{$data->password}}" style="margin-left:15%" disabled/>
        </div>

        <div style="width:800px">
            <label style="float:left;padding-left:15%">New Password:</label>
            <input type="password" name="password" class="field-style field-full align-none form-control" value="{{ $data->password }}" style="margin-left:15%"/>
        </div>
        <div style="width:800px">
